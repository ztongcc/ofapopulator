#
#  Be sure to run `pod spec lint ofapopulator.podspec' to ensure this is a
...
self.populator = [[OFAViewPopulator alloc] initWithParentView:self.tableView
  ...
  # Or just: s.author    = "Manuel Meyer"
  # s.authors            = { "Manuel Meyer" => "manuel.meyer@goeuro.com" }
  # s.social_media_url   = "http://twitter.com/Manuel Meyer"
  ...
  s.source       = { :git => "https://github.com/vikingosegundo/ofapopulator.git", :tag => "0.0.1" }
